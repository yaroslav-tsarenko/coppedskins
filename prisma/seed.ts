...
async function main() {
  ...
  const page = await prisma.page.upsert({
    ...
    create: {
      ...
      slug: "about-us",
      content:
        "<p>Welcome to Coppedskins — a curated apparel edit for men, women and kids.</p><p>We design and source athletic and everyday apparel with sustainable materials — organic cottons, recycled polyesters, and honest fits. Shipped from the United Kingdom with free delivery over £100.</p>",
      isActive: true,
    },
  });
