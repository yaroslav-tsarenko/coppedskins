...
async function main() {
  ...
  await c.query(
    `INSERT INTO "StoreSettings" (id, name, description, "primaryColor", "secondaryColor", email, currency, "taxRate", "freeShippingMin", "metaTitle", "metaDescription", "updatedAt")
     VALUES ('default', $1, $2, '#0F172A', '#FFFFFF', 'info@coppedskins.co.uk', 'GBP', 20, 100, $3, $4, $5)
    ...
    [
      ...
      "Coppedskins — Refined athletic apparel",
      "Curated apparel from Coppedskins — sustainably sourced tees, hoodies and swimwear for men, women and kids. Shipped from the United Kingdom.",
      now,
    ],
  );
