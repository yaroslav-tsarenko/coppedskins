...
// Anton = the poster face: one heavy condensed weight, set uppercase for
// headlines, section titles and skin model names — the Drop District voice.
// Inter = neutral UI body. JetBrains Mono = authentication-tag data.
const anton = Anton({
  variable: "--font-anton",
  weight: "400",
  subsets: ["latin"],
