  ...
  return (
    <PolicyLayout title="Privacy Policy" lastUpdated="9 August 2026">
      <p>
        ...
        access or use coppedskins.com, create an account, sign in through Steam, purchase a Digital Item, receive
      ...
      <p>
        In this Policy, &ldquo;Coppedskins&rdquo;, &ldquo;ULTRASENS&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;
      ...
      <ul>
        <li>coppedskins.com;</li>
        <li>your Coppedskins Account;</li>
        <li>Steam Login;</li>
      ...
      <p>
        At the date of publication, Coppedskins does not use third-party advertising cookies, behavioural
      ...
      <p>At the date of publication, Coppedskins does not use personal data for behavioural advertising or third-party analytics.</p>
      ...
      <p>You should access Steam Login only through an official Steam domain and must never provide Steam credentials directly to Coppedskins or a Fulfilment Provider.</p>
      ...
      <p>Coppedskins does not currently use personal data for behavioural advertising or profiling unrelated to transaction security.</p>
      ...
      <p>You may ask us to correct inaccurate personal data or complete incomplete data. Some Steam information must be corrected through Steam before the updated information can be retrieved by Coppedskins.</p>
      ...
      <p>You may object to direct marketing at any time. Coppedskins does not currently send behavioural advertising or share data for such advertising.</p>
      ...
      <p>Coppedskins may use strictly necessary cookies or similar storage technologies for:</p>
      <ul>
        <li>Steam Login;</li>
      ...
      <p>At the date of publication, Coppedskins does not use:</p>
      <ul>
      ...
      <p>The updated Policy will be published on coppedskins.com with a revised effective date.</p>
