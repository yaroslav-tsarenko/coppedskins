...
export const metadata = { title: "Refund, Cancellation and Withdrawal Policy — Coppedskins" };
  ...
  return (
    <PolicyLayout title="Refund, Cancellation and Withdrawal Policy" lastUpdated="9 August 2026">
      <p>
        ...
        through coppedskins.com may be cancelled and when a refund, replacement, price reduction or other remedy
        may be available.
      </p>
      ...
      <p>
        ...
        (&ldquo;Digital Items&rdquo;), made through Coppedskins.
      </p>
      <p>
        Each purchase is paid through a separate Visa or Mastercard transaction. Coppedskins does not provide a
      ...
      <p>Before beginning immediate performance during the withdrawal period, Coppedskins may ask you to:</p>
      <ul>
      ...
      <p>
        Do not use Steam&rsquo;s trade reversal functionality as a substitute for contacting Coppedskins about a
      ...
      <ul>
        <li>suspension or termination of the Coppedskins Account;</li>
