  ...
  return (
    <PolicyLayout title="Digital Item Delivery Policy" lastUpdated="9 August 2026">
      <p>
        ...
        purchased through coppedskins.com are delivered to users through Steam.
      </p>
      <p>This Policy forms part of the Coppedskins Terms and Conditions of Purchase and Use.</p>
      ...
      <p>
        ...
        (&ldquo;Digital Items&rdquo;), purchased through Coppedskins.
      </p>
      ...
      <p>The Steam Account sending the Item may not display the Coppedskins name or branding.</p>
      <p>
      ...
      <ul>
        <li>be connected to your Coppedskins Account;</li>
      ...
      <ul>
        ...
        <li>it belongs to the Steam Account connected to Coppedskins; and</li>
      ...
      <p>
        ...
        Trade URL stored through Coppedskins before placing another Order.
      </p>
      ...
      <ul>
        <li>through your Coppedskins Account;</li>
      ...
      <ul>
        <li>be sent to the Steam Account connected to Coppedskins;</li>
      ...
      <p>Coppedskins will never require you to provide through a Steam Trade Offer:</p>
      <ul>
      ...
      <ul>
        ...
        <li>you cannot reasonably connect it to your Coppedskins Order.</li>
      </ul>
      <p>
      ...
      <p>
        ...
        connected to your Coppedskins Account.
      </p>
      ...
      <ul>
        ...
        <li>check the Order status through Coppedskins; and</li>
      ...
      <p>
        We deliver only to the Steam Account connected to the Coppedskins Account and identified by the Trade URL
      ...
      <p>Coppedskins support will not ask you to disable Steam Guard or other security protections.</p>
      ...
      <p>The current version will be published on coppedskins.com with an updated effective date.</p>
