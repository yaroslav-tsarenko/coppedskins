...
export default function CookiePolicyPage() {
  return (
    <PolicyLayout title="Cookie Policy" lastUpdated="9 August 2026">
      ...
      <p>
        This Policy should be read together with the Coppedskins Privacy Policy and Terms and Conditions of
        Purchase and Use.
      </p>
      <p>The Service is operated by:</p>
      <ContactBlock />
      <p>
        In this Policy, &ldquo;Coppedskins&rdquo;, &ldquo;ULTRASENS&rdquo;, &ldquo;we&rdquo;,
      ...
      <p>
        At the date of publication, Coppedskins uses or may use only cookies and similar technologies that
        are strictly necessary to operate, secure and deliver the Service.
      </p>
      <p>Coppedskins does not currently use:</p>
      <ul>
      ...
      <p>Steam Login does not give Coppedskins access to your Steam password.</p>
      ...
      <p>
        ...
        Coppedskins does not control cookies placed directly by Steam.
      </p>
      ...
      <ul>
        ...
        <li>return the transaction status to Coppedskins.</li>
      </ul>
      <p>
        The payment service provider may process these technologies under its own privacy documentation and
        regulatory responsibilities.
      </p>
      <p>Coppedskins does not use payment cookies for advertising.</p>
      ...
      <p>
        Coppedskins is not responsible for Service failures caused solely by a user blocking technologies
        required to provide a requested function.
      </p>

      <h2>11. Cookie Consent</h2>
      <p>
        Coppedskins does not currently use non-essential analytics, advertising or marketing cookies.
      </p>
      <p>
      ...
      <p>
        Because Coppedskins does not currently use behavioural advertising or cross-site tracking, such
      ...
      <p>The current version will be published on coppedskins.com with a revised effective date.</p>
      <p>
