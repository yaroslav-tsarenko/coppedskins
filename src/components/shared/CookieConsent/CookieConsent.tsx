...
const STORAGE_KEY = "coppedskins-cookie-consent-v1";
export const COOKIE_SETTINGS_EVENT = "coppedskins:cookie-settings";
...
function writeConsent(consent: StoredConsent) {
  try {
    ...
    window.dispatchEvent(new CustomEvent("coppedskins:consent-updated", { detail: consent }));
  } catch {
    /* noop */
  }
}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1.5 text-[13px] leading-relaxed text-[color:var(--color-text-secondary)]">
                  ...
                  permission we also use analytics to improve Coppedskins.{" "}
                  <Link
